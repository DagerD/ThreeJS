(function() {
  ...
  var cameraControls, transControl, container;
  ...
  //var URL = 'https://unpkg.com/world-atlas@1/world/50m.json';
  //var URL = 'ppt.topojson';
  var URL = 'ppt_4326.topojson';
  ...
  d3.json(URL, function (error, topology) {
    ...
    scene.add(mesh = wireframe(topojson.mesh(topology, topology.objects.ppt_4326), new THREE.LineBasicMaterial({ color: 0xff0000 })));
    alert(Object.keys(topology.objects.ppt_4326.geometries).length);
